  ...
  return (
    ...
    <div className="flex items-center cursor-pointer">
        <div className="ml-0 hidden tablet:flex">
            <a href="#top" className="scroll-smooth" title="Home">
        ...
        <div className="ml-5 hidden tablet:flex" title="Footer">
            <a href="#bottom" className="scroll-smooth relative">
                ...
                <p className="w-3 h-3 flex bg-red-500 rounded-full justify-center items-center animate-pulse text-[10px] text-white absolute top-0 left-4">3</p>
            </a>
        </div>
        {/* dropdown on bigger screen devices */}
