      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex space-x-5">
          <div className="space-y-2" onClick={() => {}}>
            <img
              alt=""
              className="w-14 h-14 rounded-full ring-2 ring-offset-2 bg-gray-500 ring-pink-400  ring-offset-white hover:scale-110 hover:transition-all hover:ease-in-out"
